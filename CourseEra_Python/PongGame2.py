...
It's an adaptation of my previous work
...
class Pong:
    ...
    def nb_balls(self):
        ...
        :return: int >= 0
        """
        return len(self.balls) + len(self.balls_to_launch)
...
def draw(c):
    ...
    label_nb_balls.set_text('# balls: %i' % pong.nb_balls())
...
frame.add_label('')
label_nb_balls = frame.add_label('# balls: 1')
